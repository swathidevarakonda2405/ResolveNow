                     ...
                     <div className="card gray">
                        <div className="card-body p-5 text-center gray">
                           <div className="mb-md-5 mt-md-4 pb-5">
                              <h2 className="fw-bold mb-4 ">SignUp For Registering the Objection</h2>
                              <p className="fw-bold text-black-70 mb-4">Please enter your Details</p>
                              <form onSubmit={handleSubmit}>
                                 <div className="form-outline fw-bold form-black mb-4">
                                    <input type="name" name="name" value={user.name} onChange={handleChange} className="form-control form-control-lg" required />
                                    <label className="form-label" htmlFor="email">Name as per SSC</label>
                                     </div>
                                 <div className="form-outline fw-bold form-white mb-2">
                                 ...
                                 <button className="btn btn-outline-white fw-bold btn-lg px-5 mt-3" type="submit">Register</button>
                              </form>
                           </div>
                           <div>
                              <p className="mb-0 fw-bold">Had an account?<Link to={"/Login"}>Login</Link></p>
                           </div>
                        </div>
                     </div>
                  </div>
